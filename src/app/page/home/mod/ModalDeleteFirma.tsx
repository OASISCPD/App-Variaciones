import type { CajaDTO, ValeDTO } from "../../../types";
...
interface ModalQuestionProps {
    ...
    confirm: () => void
    cancel: () => void
    item: CajaDTO | ValeDTO | null
}
export const ModalQuestionDelete: React.FC<ModalQuestionProps> = ({ cancel, confirm, text, subText }) => {
    return (
